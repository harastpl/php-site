...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="#data-deletion-retention">Data Deletion and Retention</a>
    ...
    <main class="content">
        <div class="container mt-5 mb-5">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <h1 id="terms-conditions" class="mb-4">Terms and Conditions</h1>
                    
                    <div class="card">
                        <div class="card-body">
                            <h1>1. Terms & Conditions</h1>
            ...
            <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.volt3dge.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
            
            <p>The Platform is owned by MR JAYANT NANDLE, a company incorporated under the Companies Act, 1956 with its registered office at Indore, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</p>
            ...
            <p class="highlight uppercase">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</p>
            ...
            <p>1. To access and use the Services, you agree to provide true, accurate and complete information to us during and after registration, and you shall be responsible for all acts done through the use of your registered account on the Platform.</p>
            ...
            <p>3. Your use of our Services and the Platform is solely and entirely at your own risk and discretion for which we shall not be liable to you in any manner. You are required to independently assess and ensure that the Services meet your requirements.</p>
            
            <p>4. The contents of the Platform and the Services are proprietary to us and are licensed to us. You will not have any authority to claim any intellectual property rights, title, or interest in its contents. The contents includes and is not limited to the design, layout, look and graphics.</p>
            
            <p>5. You acknowledge that unauthorized use of the Platform and/or the Services may lead to action against you as per these Terms of Use and/or applicable laws.</p>
            
            <p>6. You agree to pay us the charges associated with availing the Services.</p>
            
            <p>7. You agree not to use the Platform and/ or Services for any purpose that is unlawful, illegal or forbidden by these Terms, or Indian or local laws that might apply to you.</p>
            
            <p>8. You agree and acknowledge that website and the Services may contain links to other third party websites. On accessing these links, you will be governed by the terms of use, privacy policy and such other policies of such third party websites. These links are provided for your convenience for provide further information.</p>
            ...
            <p>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Indore and Madhya Pradesh.</p>
            ...
            <p>All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website.</p>
                            ...
                            <h1 id="privacy-policy">2. Privacy Policy </h1>
                            <h2 id="introduction">Introduction</h2>
            <p>This Privacy Policy describes how MR JAYANT NANDLE and its affiliates (collectively "MR JAYANT NANDLE, we, our, us") collect, use, share, protect or otherwise process your information/ personal data through our website www.volt3dge.com (hereinafter referred to as Platform). Please note that you may be able to browse certain sections of the Platform without registering with us.</p>
            ...
            <p class="highlight">If you receive an email, a call from a person/association claiming to be MR JAYANT NANDLE seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.</p>
            ...
            <p>We may disclose personal data to third parties such as sellers, business partners, third party service providers including logistics partners, prepaid payment instrument issuers, third-party reward programs and other payment opted by you. These disclosure may be required for us to:</p>
            <ul>
            ...
            <p>We may disclose personal data to law enforcement offices, third party rights owners, or others in the good faith belief that such disclosure is reasonably necessary to:</p>
            <ul>
                <li>Enforce our Terms of Use or Privacy Policy</li>
                <li>Respond to claims that an advertisement, posting or other content violates the rights of a third party</li>
                <li>Protect the rights, property or personal safety of our users or the general public</li>
            </ul>
            ...
            <h2 id="data-deletion-retention">Data Deletion and Retention</h2>
            ...
            <h2 id="changes-privacy-policy">Changes to this Privacy Policy</h2>
            ...
            <div class="contact-info">
                ...
                <p><strong>Jayant Nandle</strong><br>
                Proprietor<br>
